...
/*   Updated: 2024/11/30 23:42:58 by antonsplavn      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	parsing(t_philo *philo, int argc, char **argv)
{
	...
	if (process_and_validate_argument(argv[2]) == 0)
		philo->time_to_die = ft_atoi(argv[2]);
	if (process_and_validate_argument(argv[3]) == 0)
		philo->time_to_eat = ft_atoi(argv[3]);
	if (process_and_validate_argument(argv[4]) == 0)
		philo->time_to_sleep = ft_atoi(argv[4]);
	if (argc == 6)
	{
		if (process_and_validate_argument(argv[5]) == 0)
